...
<body>
<form id="submitForm" name="submitForm" action="mag_updateData.action" method="post">
	...
	<div id="container">
		<div id="nav_links">
			<h3 style="color: #1A5CC6;margin-left: 50px;">管理员编辑</h3>
		</div>
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					...
					<td class="ui_text_lt" width=""><font color="red"><s:fielderror><s:param>name</s:param></s:fielderror></font></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
